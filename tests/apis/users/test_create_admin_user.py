...
#     # then
#     assert response.status_code == status.HTTP_400_BAD_REQUEST
#     assert response.json()["detail"] == "이미 등록돤 아이디입니다."
...
#     # then
#     assert response.status_code == status.HTTP_400_BAD_REQUEST
#     assert response.json()["detail"] == "비밀번호는 최소 하나의 숫자를 포함해야 합니다."
...
#     assert response.status_code == status.HTTP_400_BAD_REQUEST
#     assert (
#         response.json()["detail"] == "비밀번호는 최소 5자 이상이어야 합니다."
#     )  # 실제 메시지로 가정
...
#     assert response.status_code == status.HTTP_400_BAD_REQUEST
#     assert (
#         response.json()["detail"] == "비밀번호는 최소 하나의 문자를 포함해야 합니다."
#     )  # 실제 메시지로 가정
...
#     assert response.status_code == status.HTTP_400_BAD_REQUEST
#     assert (
#         response.json()["detail"] == "유효하지 않은 전화번호 형식입니다."
#     )  # 실제 메시지로 가정
